...
//
// Library goal:
// Implement ECDSA most closely to how it Ethereum does, but take into account Credits technical specification (like use
// of EC 25519 for signing and blake2 for hashing).
//
...
// 2. Generate key pair in a one function call (due to ed25519 limitations), Ethereum generates Secret first, then uses
// it to generate Public
