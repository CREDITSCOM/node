...
operator<(const _Variant__isset& a, const _Variant__isset& b)
{
    auto ta = std::tie(a.v_bool,
                       ...
                       a.v_set,
                       a.v_string);
    decltype(ta) tb = std::tie(b.v_bool,
                               b.v_double,
                               b.v_i16,
                               b.v_i32,
                               b.v_i64,
...
bool
Variant::operator<(const Variant& that) const
{
    ...
    if (a.__isset.v_list) {
        return std::lexicographical_compare(
          a.v_list.begin(), a.v_list.end(), b.v_list.begin(), b.v_list.end());
    }
    if (a.__isset.v_set) {
        return std::lexicographical_compare(
          a.v_set.begin(), a.v_set.end(), b.v_set.begin(), b.v_set.end());
    }
    if (a.__isset.v_map) {
        return std::lexicographical_compare(
          a.v_map.begin(), a.v_map.end(), b.v_map.begin(), b.v_map.end());
    }
    assert(false);
    return false;
}