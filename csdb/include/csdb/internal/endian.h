...
inline constexpr to_little_endian(T value)
{
  return value;
}
...
template <typename T>
typename ::std::enable_if<::std::is_integral<T>::value, T>::type
inline constexpr from_little_endian(T value)
{
  return value;
}
...
template <typename T>
typename ::std::enable_if<::std::is_integral<T>::value, T>::type
inline constexpr to_big_endian(T value)
{
...
template <typename T>
typename ::std::enable_if<::std::is_integral<T>::value, T>::type
inline constexpr from_big_endian(T value)
{
  return reverse_byte_order(value);
}
