...
public:
  ...
  inline bool operator==(const shared_data_ptr<T> &other) const { return d == other.d; }
  inline bool operator!=(const shared_data_ptr<T> &other) const { return d != other.d; }
...
static_assert((sizeof(shared_data_ptr<int>) == sizeof(void*)),
              "Invalid csdb::shared_data_ptr definition.");
