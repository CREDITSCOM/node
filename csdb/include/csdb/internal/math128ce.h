...
private:
  ...
  constexpr inline division64_result div2(const division64_result& previous, const uint64_t divisor,
                                          const size_t shift) const;
  constexpr inline division64_result div3(const division64_result& previous, const uint64_t divisor, const uint64_t bit,
...
constexpr inline csdb::internal::uint128_t csdb::internal::uint128_t::operator+(const uint64_t summand) const noexcept {
  return ((0xFFFFFFFFFFFFFFFFULL - lo_) < summand) ? uint128_t(lo_ - (0xFFFFFFFFFFFFFFFFULL - summand + 1), hi_ + 1)
                                                   : csdb::internal::uint128_t(lo_ + summand, hi_);
}

constexpr inline csdb::internal::uint128_t csdb::internal::uint128_t::operator+(const uint128_t& summand) const
    noexcept {
...
constexpr inline csdb::internal::uint128_t csdb::internal::uint128_t::mul1(const uint64_t a, const uint64_t b,
                                                                           const uint64_t c, const uint64_t d) {
  return mul2(a * c, a * d, b * c, b * d);
}

constexpr inline csdb::internal::uint128_t csdb::internal::uint128_t::mul2(const uint64_t ac, const uint64_t ad,
                                                                           const uint64_t bc, const uint64_t bd) {
  return uint128_t(bd, ac + (ad >> 32) + (bc >> 32)) + (ad << 32) + (bc << 32);
}

constexpr inline csdb::internal::uint128_t::division64_result csdb::internal::uint128_t::div(
    const uint64_t divisor) const {
  return (0ULL == divisor)
...
constexpr inline csdb::internal::uint128_t::division64_result csdb::internal::uint128_t::div1(
    const division64_result& previous, const uint64_t divisor, const size_t shift) const {
  return (0 == shift) ? div2(previous, divisor, shift) : div1(div2(previous, divisor, shift), divisor, shift - 1);
}

constexpr inline csdb::internal::uint128_t::division64_result csdb::internal::uint128_t::div2(
    const division64_result& previous, const uint64_t divisor, const size_t shift) const {
  return div3(previous, divisor, 1ULL << shift, (previous.remainder_ << 1) + ((lo_ >> shift) & 0x1));
}

constexpr inline csdb::internal::uint128_t::division64_result csdb::internal::uint128_t::div3(
    const division64_result& previous, const uint64_t divisor, const uint64_t bit, const uint64_t dividend) const {
