...
: integral_(integral)
, fraction_(_check_fraction(
      (internal::uint128_t::mul(numerator, AMOUNT_MAX_FRACTION) + (denominator / 2)).div(denominator).quotient_)) {
}
...
: Amount(((0 == value.lo_) && (0 == value.hi_))
             ...
             : divide ? value.div(AMOUNT_MAX_FRACTION).quotient_.div(AMOUNT_MAX_FRACTION)
...
inline constexpr Amount Amount::operator*(const Amount& other) const noexcept {
  return (0 > integral_)
             ...
             : (0 > other.integral_) ? this->operator*(-other).operator-()
...
inline constexpr Amount Amount::operator*(const int32_t other) const noexcept {
  return (0 > other) ? this->operator*(-other).operator-()
  ...
  return (0 == other)
             ...
             : (0 > other)
                   ...
                   : (1 == other)
                         ...
                         : (0 > integral_)
                               ? this->operator-().operator/(other).operator-()
                               : Amount(internal::uint128_t::mul(integral_, AMOUNT_MAX_FRACTION).div(other).quotient_,
                                        false) +
